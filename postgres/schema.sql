...
CREATE TABLE IF NOT EXISTS "poutbox".immediate(
    ...
    commit_lsn pg_lsn NOT NULL DEFAULT pg_current_wal_lsn(),
...
INSERT INTO "poutbox".cursor
    (id, last_processed_id, last_processed_at, last_processed_transaction_id) 
    VALUES 
    (1, 0, '1970-01-01'::timestamptz(6), 0) ON CONFLICT DO NOTHING;
